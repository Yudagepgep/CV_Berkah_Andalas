...
public class product {
    ...
    public product(String id, String tanggal, String costumer, String nama_produk, String nama_bahan, String nama_plat, String quantity
                   , String lebar_bahan, String tinggi_bahan, String lebar_cetak, String tinggi_cetak, String banyak_bahan, String satuan, String total_harga, String jawab, String status ) {
        this.id = id;

package com.aplikasi.ADMIN.input;
...
import com.aplikasi.ADMIN.Bahan.Data_Bahan;
import com.aplikasi.ADMIN.Pemesanan_Costumer.Pemesanan;
import com.aplikasi.ADMIN.Plat.Data_Plat;
...
public class INPUT_PESANAN extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Spinner pesanan, user;
    EditText tgl, quantity,
             jawab, lb_ctk, tg_ctk, lb_ar, tg_ar, lb,st;
    Button back, simpan;

    ArrayList<String> pemesanan = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pesanan = findViewById(R.id.id_pesanan);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(INPUT_PESANAN.this,Menu.class);
                startActivity(intent);
            }
        });
        simpan = (Button) findViewById(R.id.simpan_pesan);
    ...
    private void pesanan() {
        ...
        String ID_USER = "https://berkah-andalas06.000webhostapp.com/User/nama_user.php";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, ID_USER,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            JSONArray jsonArray = jsonObject.getJSONArray("Hasil");
                                ...
                                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(context, android.R.layout.simple_spinner_dropdown_item, pemesanan);
    ...
    private void getProduk(JSONArray j) {
        ...
        user.setAdapter(new ArrayAdapter<String>(context, android.R.layout.simple_spinner_dropdown_item, produk));
    ...
    private void simpan_pesan() {
        ...
        final String id_pesanan = pesanan.getSelectedItem().toString();
        final String id_produk = user.getSelectedItem().toString();
        final String tanggal = tgl.getText().toString().trim();
        final String quan = quantity.getText().toString().trim();
        final String penanggung_jawab = jawab.getText().toString().trim();
        final String laba = lb.getText().toString().trim();
        final String stus = st.getText().toString().trim();

        String url = "https://berkah-andalas06.000webhostapp.com/Pesanan/Input_Pesanan.php";
                        ...
                        try {
                            ...
                            if (status.equalsIgnoreCase("Data tersimpan")) {
                               androidx.appcompat.app.AlertDialog.Builder builder=new androidx.appcompat.app.AlertDialog.Builder(INPUT_PESANAN.this);
                                ...
                                Toast.makeText(INPUT_PESANAN.this, "Data Gagal Tersimpan" , Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
         if (item.getItemId() == R.id.tb_data_pemesanan) {
            startActivity(new Intent(this, Pemesanan.class));

        }else if (item.getItemId() == R.id.tb_antrian) {
            startActivity(new Intent(this, Tabel_Antrian.class));

         }else if (item.getItemId() == R.id.tb_produk) {
             startActivity(new Intent(this, Data_Produk.class));

        }
        else if (item.getItemId()==R.id.tb_bahan) {
             startActivity(new Intent(this, Data_Bahan.class));
        }else if (item.getItemId()==R.id.tb_data_plat) {
             startActivity(new Intent(this, Data_Plat.class));
         }
                return true;
        }

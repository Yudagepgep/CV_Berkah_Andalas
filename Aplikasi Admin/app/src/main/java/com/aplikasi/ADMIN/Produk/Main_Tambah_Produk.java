...
public class Main_Tambah_Produk extends AppCompatActivity {
    Spinner bahan, plat;
    EditText id, nama, tinggi, lebar;
    Button kembali_produk, tmb_produk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_tambah_produk);

        context = this;
        id = findViewById(R.id.tmb_id_produk);
        nama = findViewById(R.id.tmb_nama_produk);
        tinggi = findViewById(R.id.tmb_tinggi_cetak);
        lebar = findViewById(R.id.tmb_Lebar_Cetak);
        bahan = findViewById(R.id.tmb_id_bahan);
        plat = findViewById(R.id.tmb_id_plat);

        kembali_produk = (Button) findViewById(R.id.kembali_produk);
        kembali_produk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Main_Tambah_Produk.this, Data_Produk.class);
                startActivity(intent);
            }
        });
        tmb_produk = (Button) findViewById(R.id.tmb_produk);

        tmb_produk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                simpan_tambah_produk();
            }
        });
    ...
    private void simpan_tambah_produk() {
        ...
        String url = "https://berkah-andalas06.000webhostapp.com/Produk/Tambah_Produk.php";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (status.equalsIgnoreCase("Berhasil DiTambahkan")) {
                                androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(Main_Tambah_Produk.this);
                                builder.setTitle("Sukses");
                                builder.setMessage("Data Sukses Ditambahkan");
                                builder.setPositiveButton("oke", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        startActivity(new Intent(Main_Tambah_Produk.this, Data_Produk.class));
                                        finish();
                                ...
                                Toast.makeText(Main_Tambah_Produk.this, "Data Gagal Ditambahkan" , Toast.LENGTH_LONG).show();
